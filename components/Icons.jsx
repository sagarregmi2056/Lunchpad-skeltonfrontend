...
export const IconBuy = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clipRule="evenodd" />
    </svg>
);

export const IconSell = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const IconPrice = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const IconSupply = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const IconSlope = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
...
export const NetworkBadge = ({ network }) => {
    const bgColor = network === 'mainnet' ? 'bg-green-900/40 border-green-700/40' : 'bg-yellow-900/40 border-yellow-700/40';
    const textColor = network === 'mainnet' ? 'text-green-400' : 'text-yellow-400';

    return (
        <div className={`px-3 py-1.5 rounded-full ${bgColor} border backdrop-blur-sm`}>
            <p className="text-xs font-medium text-gray-300">Network: <span className={textColor}>{network}</span></p>
        </div>
    );
};
...
export const StatusBadge = ({ status }) => {
    ...
    return (
        <div className={`px-3 py-1.5 rounded-full ${config.bgColor} border ${config.borderColor} backdrop-blur-sm`}>
