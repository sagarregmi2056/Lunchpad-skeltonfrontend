...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 relative">
            <Head>
                <title>Solana Launchpad DEX</title>
                <meta name="description" content="A decentralized exchange (DEX) and launchpad platform built on Solana" />
            ...
            <header className="bg-gray-800/60 backdrop-blur-md shadow-lg border-b border-gray-700/60 sticky top-0 z-50">
                <div className="container-fluid py-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-3">
                            ...
                            <h1 className="text-2xl font-bold text-white tracking-tight">SolanaLaunchpad</h1>
                        </div>

                        <div className="flex items-center space-x-4">
                            {mounted && publicKey && (
                                <div className="hidden sm:flex items-center space-x-2 bg-gray-800/90 rounded-lg px-3 py-1.5 border border-gray-700/60">
                                    <div className="h-2 w-2 rounded-full bg-green-400 animate-pulse-slow"></div>
                        ...
                        <div className="flex min-w-full">
                            {tabs.map((tab) => (
                                <button
                                    ...
                                    className={`nav-tab whitespace-nowrap ${activeTab === tab.id ? 'nav-tab-active' : 'nav-tab-inactive'}`}
            ...
            <footer className="bg-gray-800/60 backdrop-blur-md mt-8 py-5 border-t border-gray-700/60">
                <div className="container-fluid">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-center text-gray-500 text-xs mb-3 md:mb-0">
                            © {new Date().getFullYear()} SolanaLaunchpad DEX. All rights reserved.
                        </p>
